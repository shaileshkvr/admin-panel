...
const AppBarChart = () => {
  ...
  const chartData = [
    ...
    { month: "August", desktop: 16000, mobile: 12300 },
    { month: "September", desktop: 21490, mobile: 18100 },
    { month: "October", desktop: 23000, mobile: 24200 },
    { month: "November", desktop: 27050, mobile: 30300 },
    { month: "December", desktop: 31800, mobile: 36900 },
  ];
